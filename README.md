...
- 🔨 Fases 5–12 — ✅Modelado 3D (11) → ✅Blender (12) → ✅modelado en Blender (8) → 🔨texturizado (incl. addons, bpy, blender-mcp) → modelado en Blender → texturizado → rigging → animación → animación en Blender → pipeline de assets Blender↔Unity
